...
export default function Home() {
  ...
  return (
    <ThemeProvider theme={theme}>
          ...
          <ContainerBox>
            ...
            <NoticeList>
              ...
              <ul className="notice-list">
                <a href="">
                  <li>
                    <h3>후기등록 하면 스타벅스 커피 증정<span>NEW</span></h3>
                    <p>2024-05-03</p>
                  </li>
                </a>
                <a href="">
          ...
          <ContainerBox>
            <BoxThList>
              ...
              <div className="w-33 box">
                  ...
                  꼭 알고 싶은 정보로 먼저 실거주한 사람만 <br/>
                  알 수 있는 상세한 정보 를 제공합니다.
                  </p>
              </div>
            </BoxThList>
          </ContainerBox>
        ...
        <MainSection>
          <MainTitle>
            <h1>후기 쓰고 <strong>돈 벌기</strong></h1>
          </MainTitle>
          <InfoWrap>
            <ContainerBox>
              ...
              <BoxThList>
                <div className="w-33 box3">
                    <h2>유료 후기부등본</h2>
                    <p>
                    <strong>실거주 인증 후기부등본</strong>은 유료로 제공됩니다.  <br/>
                    실거주 인증은 <strong>우편물 송장, 임대차계약서  <br/>
                    또는 주민등록등본 사본</strong>을 통해 진행합니다.  <br/>  <br/>
        ...
        <MainSection>
          <MainTitle>
            <h1>친구 추천하고 <strong>돈 벌기</strong></h1>
          </MainTitle>
          <InfoWrap>
            <ContainerBox>
            <div className="info-img info-img2"></div>
              <BoxThList>
                <div className="w-33 box3 h-26">
                    ...
                    <br/><br/>
                    팔로워가 후기부등본을 등록하고 <br/>
                    <strong> 판매가 될 때 마다 계속 </strong> 추천한 회원에게도 <br/>
                    이용료를 쉐어합니다.
                    </p>
                </div>
                <div className="w-33 box3 h-26">
                    <h2>팔로워 수익</h2>
                    <p>
                    팔로워가 후기부등본을 판매할 때마다 <strong> 이용료의 최대 6%(친구가 받는 수익의 최대 10%만큼)</strong>를 팔로워를 추천한 회원에게 지급합니다. 
                    팔로워 수익은 팔로워 부터 받는 것이 아니라 
                    회사가 별도로 지급합니다.
                    </p>
                </div>
                <div className="w-33 box3 h-26">
        ...
        <ContactBanner>
            <ContainerBox>
                <div className="left-box">
                  <h1>후기부등본<br/>
                  실거주 후기 등록하고 돈 벌어 보세요.</h1>
                  <p>
                  회원가입 시 추천인 ID를 입력해 주세요.
                  </p>
                </div>
...
const BoxThList = styled(Box)`
  ...
  .box2{
    ...
    background-color: #fff;
    padding: 4rem;
    box-shadow: 4px 12px 20px rgba(0,0,0,.05);
    min-height: 27rem;
    max-height: 27rem;
    h2{
      font-size: 2.8rem;

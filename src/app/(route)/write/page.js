            ...
            <ThemeProvider theme={theme}>
                ...
                <WriteWrap>
                    <ContainerBox3>
                        ...
                        <h3>실거주 후기부등본은 <strong>유료로 판매</strong>됩니다.<br/>
                        후기등록자에게 <strong>판매수익의 60%</strong>를 지급해드립니다.<br/>
                        <strong>2000년 이후 실거주 했던 여러 주소지에 대해 최대 30건</strong>까지 등록할 수 있습니다.</h3>
                        ...
                        <WriteBox>
                            <WriteTitle num={"1단계"} text={"실거주 했던 주소를 입력해 주세요."}/>
                            <ul>
                                <li>
                                    <h4>도로명 주소</h4>

        ...
        <>
            <ThemeProvider theme={theme}>
                ...
                <WriteWrap>
                    <ContainerBox3>
                    <WriteBox>
                        <WriteTitle num={"마지막단계"} text={"실거주 인증 서류를 첨부해 주세요."}/>
                        ...
                        <ul className="detail-box">
                            <li>1. 회원명과 거주지 주소가 정확히 표시된 서류 1건을 등록해주세요.</li>
                            <li>2. 등록서류 ①우편물 송장 사본 ②임대차계약서 사본 ③주민등록본 사본</li>
                            <li>3. 실거주 인증 서류를 등록하지 않은 경우, 실거주 미인증 후기부등본 등록되고 무료로 공개 됩니다</li>
                        </ul>
                    </WriteBox>
                    <EndButton>
                        <BasicBtn text={"이전"} />
                        ...
                        <BasicModal handleClose={handleClose} open={open} title={"실거주 미인증 후기부등본(무료)으로 등록 "} content={"실거주인증"}/>
                    </EndButton>
                    </ContainerBox3>
                </WriteWrap>
                <Footer />

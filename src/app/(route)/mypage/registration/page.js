                        ...
                        <RegistrationWrap>
                            <ul>
                                <li>
                                    <h3>공인중개사 검증단</h3>
                                    <p>
                                        공인중개사 검증단은 이용자의 요구에 따라 해당물건 의 실거주자 후기부등본을 확인하고 <br/>
                                ...
                                <li>
                                    <h3>신청자격</h3>
                                    <p>
                                        회원 본인이 공인중개사인 경우 <strong>공인중개사 자격증 사본</strong> 제출
                                    </p>
                                </li>
                                <li>
                                    <h3>검증방법</h3>
                                    <p>
                                        1. 이용자의 검증신청 시 공인중개사 선택<br/>
                                ...
                                <li>
                                    <h3>검증단 등록비</h3>
                                    <p><strong>165,000원</strong>(부가세포함)</p>
                                </li>
                                <li>
                                    <h3>검증단 자격 유지기간</h3>
                                    <p>결제일로부터 <strong>1년</strong></p>
                                </li>
                            </ul>
                            <div className="bottom-btn">
                                <BasicBtn text={"공인중개사 검증단 등록"} href={"/mypage/registration/agent"}/>
                            </div>
                        </RegistrationWrap>
                    </MobileContainerBox>
                </MobileBox>

                            ...
                            </div>
                            {
                                    ...
                                    <ReviewList>
                                    {
                                        ...
                                        <>
                                            <div className="up-slide-title">
                                                <h3>총 <strong>6개</strong>의 후기부등본이 있습니다.</h3>
                                                <IconButton onClick={handleClickUp}><KeyboardArrowUpIcon/></IconButton>
                                            </div>
                                    ...
                                    }
                                {
                                    ...
                                    <ReviewListTop>
                                        <div className="up-slide-title">
                                            <h3>총 <strong>6개</strong>의 후기부등본이 있습니다.</h3>
                                            <IconButton onClick={handleClickUp}><KeyboardArrowDownIcon/></IconButton>
                                        </div>
                                        <UpList>
                                            <div className="box-shadow-none">
                                                <AttestedCopy tag1={true} tag2={true} tag3={true} price={"3,300원"}/>

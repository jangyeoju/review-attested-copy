                ...
                <PaymentWrap>
                    ...
                    <PaymentBox>
                            ...
                            <li>
                                <div className="coupon-list">
                                    ...
                                    <div className="input-box-wrap">
                                        ...
                                        <BasicModal handleClose={handleClose} open={open} title={"쿠폰 선택"} content={"쿠폰선택"}/>
                                    </div>
                                </div>
                                <div className="coupon-list">
                                    <div className="text-box">
                                    ...
                                    <div className="input-box-wrap">
                                        <div className="input-box">
                                            <InputTextEnd state={"error"} helperText={"보유포인트를 초과할 수 없습니다."} InputAdornment={"원"}/>
                                            <div className="btn-wrap">
                                                <p>5,500원</p>
                                                <Button variant="outlined" onClick={handleClickOpen2}>포인트 충전</Button>
                                                <BasicModal handleClose={handleClose2} open={open2} title={"포인트 충전"} content={"포인트충전"}/>
                                            </div>
                                        </div>
                                    ...
                                    <div className="coupon-list">
                                        ...
                                        <div className="text-box">
                                            <FormControl>
                                                ...
                                                >
                                                    <StyledFormControlLabel value="female" control={<Radio />} label="신용카드 결제" />
                                                    <StyledFormControlLabel value="male" control={<Radio />} label="간편 결제" />
                                                </StyledRadioGroup>
                                            </FormControl>
                                        </div>
                                    </div>
                        ...
                        <ButtonWrap>
                            ...
                            <BasicModal handleClose={handleClose3} open={open3} title={"결제 완료"} content={"결제완료"}/>
                        </ButtonWrap>
                    </PaymentBox>
                </PaymentWrap>
            </ContainerBox>

...
export default function CheckWriteBox({num,categoryName,qText, qtype, addBox, }){
                    ...
                    </div>
                    {
                        ...
                        <FormControl>
                            <RadioGroup
                                ...
                                >
                                <StyledFormControlLabel value="0" control={<Radio />} label="매우 많다(0)" />
                                <StyledFormControlLabel value="1" control={<Radio />} label="있는 편이다(1)" />
                                <StyledFormControlLabel value="3" control={<Radio />} label="없는 편이다(3)" />
                                <StyledFormControlLabel value="5" control={<Radio />} label="전혀 없다(5)" />
                            </RadioGroup>
                        </FormControl> : <></>
                    }
                    {
                        ...
                        <AddBox onClick={handleClick}>
                            ...
                            <h3>상세설명 입력 시 판매가 <strong>100원 증가</strong></h3>
                            <div className="box">
                            {
                                !add ?
                            ...
                            <div className="text-num">
                                {
                                    ...
                                    {
                                        error ?
                                        <p className="error">30자 이상 입력해야합니다.</p> :  <p className="good">판매가가 100원 상승하였습니다.</p>
                                    }
                                    </> : <></>
                                }

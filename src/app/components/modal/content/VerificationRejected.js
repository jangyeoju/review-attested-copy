        ...
        <>
           <VerificationRejectedWrap>
                ...
                <ButtonWrap>
                    ...
                    <Button color="error" variant="contained" onClick={handleClickOpen}>거절</Button>
                    <BasicModal handleClose={handleClose} open={open} title={"검증 거절"} content={"알림"} text={"검증을 거절하시겠습니까?"}/>
                </ButtonWrap>
            </VerificationRejectedWrap>
        </>
    )

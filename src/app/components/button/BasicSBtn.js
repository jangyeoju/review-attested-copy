    ...
    return(
        <>
            <ThemeProvider theme={theme}>
                {
                    state == "disabled" ?
                    <BasicBtnBox variant="outlined" disabled onClick={handleClick} color={color}>{text}</BasicBtnBox> :
                    <BasicBtnBox variant="outlined" onClick={handleClick} color={color}>{text}</BasicBtnBox>
                }
            </ThemeProvider>
        </>
    )
